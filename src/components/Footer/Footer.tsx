  ...
  return (
    <footer>
      <div className="footer-info d-f jc-sb align-center">
        <h2 className="footer-info-title">Sign up and Scoot off today</h2>
        <div className="footer-info-actions d-f">
          <a href="" className='d-b'><img src="/images/app-store.svg" alt="app-store" /></a>
          <a href="" className='d-b'><img src="/images/google-play.svg" alt="google-play" /></a>
        </div>
      </div>
